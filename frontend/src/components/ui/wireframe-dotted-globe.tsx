...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  return (
    <div className={`relative ${className}`}>
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/40 backdrop-blur-sm rounded-2xl z-10">
          <div className="flex items-center space-x-2 text-cyan-400 font-mono text-sm">
            ...
            <span>Initializing D3 Orthographic Projection...</span>
          </div>
        </div>
      )}
      <canvas
      ...
      />
      <div className="absolute bottom-4 left-4 text-xs text-muted-foreground px-2 py-1 rounded-md dark bg-neutral-900 border border-neutral-800">
